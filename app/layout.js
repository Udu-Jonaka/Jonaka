...
export const metadata = {
  ...
  title: "Jonaka Udu(Jhay)",
  description:
    "I'm Jonaka Udu (Jhay), a Full-Stack Developer and Software Engineering student specializing in Node.js, Express, MongoDB, and modern web solutions. Check out my portfolio projects like Delish and Nora Nova Energies.",
  keywords:
    "Jonaka Udu, Jhay Codes, Jhay, JhayCodes, Jonaka, Udu, Udu Jonaka Nnanna, Full-Stack Developer, Software Engineer, Web Developer Nigeria, Node.js, Express.js, MongoDB, Frontend Developer, Backend Developer, Portfolio",
  authors: [{ name: "Jonaka Udu (Jhay)" }],
  robots: "index, follow",
  verification: {
  ...
  twitter: {
    ...
    title: "Jonaka Udu (Jhay) | Full-Stack Developer",
    description:
